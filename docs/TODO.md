...
| T-23 | ✅ | RocksDB per-CF tuning | Added per-CF bloom filters (BlockBasedOptions), prefix extractors (9-byte `[prefix_byte][inode]` for dir_entries/delta_entries), and LZ4 compression. | `storage/src/rocks.rs` |
