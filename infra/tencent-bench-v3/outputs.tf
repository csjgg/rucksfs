...
output "bench_driver_public_ip" {
  value = tencentcloud_instance.bench_driver.public_ip
}
output "bench_driver_private_ip" {
  value = tencentcloud_instance.bench_driver.private_ip
}
